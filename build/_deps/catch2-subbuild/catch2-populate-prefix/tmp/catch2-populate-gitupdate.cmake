...
execute_process(
  COMMAND "/usr/local/bin/git" --git-dir=.git show-ref "v2.13.9"
  WORKING_DIRECTORY "/Users/mac/Desktop/Udemy/Cmake_tests_and_tooling/newCMakeStudy/build/_deps/catch2-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/mac/Desktop/Udemy/Cmake_tests_and_tooling/newCMakeStudy/build/_deps/catch2-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/mac/Desktop/Udemy/Cmake_tests_and_tooling/newCMakeStudy/build/_deps/catch2-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
